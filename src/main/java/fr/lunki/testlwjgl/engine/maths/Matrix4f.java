package fr.lunki.testlwjgl.engine.maths;
...
public class Matrix4f {
    ...
    public static Matrix4f transform(Vector3f position, Vector3f rotation, Vector3f scale) {
        ...
        /*org.lwjglx.util.vector.Matrix4f matrix = new org.lwjglx.util.vector.Matrix4f();
        matrix.setIdentity();
        org.lwjglx.util.vector.Matrix4f.translate(new org.lwjglx.util.vector.Vector3f(position.getX(),position.getY(),position.getZ()), matrix, matrix);
        org.lwjglx.util.vector.Matrix4f.rotate((float) Math.toRadians(rotation.getX()), new org.lwjglx.util.vector.Vector3f(1,0,0), matrix, matrix);
        org.lwjglx.util.vector.Matrix4f.rotate((float) Math.toRadians(rotation.getY()), new org.lwjglx.util.vector.Vector3f(0,1,0), matrix, matrix);
        org.lwjglx.util.vector.Matrix4f.rotate((float) Math.toRadians(rotation.getZ()), new org.lwjglx.util.vector.Vector3f(0,0,1), matrix, matrix);
        org.lwjglx.util.vector.Matrix4f.scale(new org.lwjglx.util.vector.Vector3f(scale.getX(),scale.getX(),scale.getX()), matrix, matrix);
    ...
    public static Matrix4f view(Vector3f position, Vector3f rotation) {
        ...
        return result;
        /*
        org.lwjglx.util.vector.Matrix4f viewMatrix = new org.lwjglx.util.vector.Matrix4f();
        viewMatrix.setIdentity();
        org.lwjglx.util.vector.Matrix4f.rotate((float) Math.toRadians(rotation.getX()), new org.lwjglx.util.vector.Vector3f(1, 0, 0), viewMatrix,
                viewMatrix);
        org.lwjglx.util.vector.Matrix4f.rotate((float) Math.toRadians(rotation.getY()), new org.lwjglx.util.vector.Vector3f(0, 1, 0), viewMatrix, viewMatrix);
        org.lwjglx.util.vector.Vector3f cameraPos = new org.lwjglx.util.vector.Vector3f(position.getX(),position.getY(),position.getZ());
        org.lwjglx.util.vector.Vector3f negativeCameraPos = new org.lwjglx.util.vector.Vector3f(-cameraPos.x,-cameraPos.y,-cameraPos.z);
        org.lwjglx.util.vector.Matrix4f.translate(negativeCameraPos, viewMatrix, viewMatrix);
