package fr.lunki.testlwjgl.engine.graphics;
...
import fr.lunki.testlwjgl.engine.utils.FileUtils;
...
public class Shader {
    ...
    public void create() {
        ...
        if (GL20.glGetShaderi(vertexID, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
            System.err.println("Vertex Shader incorrect : " + GL20.glGetShaderInfoLog(vertexID));
            return;
        }
        ...
        if (GL20.glGetShaderi(fragmentID, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
            System.err.println("Fragment Shader incorrect : " + GL20.glGetShaderInfoLog(fragmentID));
            return;
        }
        ...
        if (GL20.glGetProgrami(programID, GL20.GL_LINK_STATUS) == GL11.GL_FALSE) {
            System.err.println("Program link error :" + GL20.glGetProgramInfoLog(programID));
            return;
        }
