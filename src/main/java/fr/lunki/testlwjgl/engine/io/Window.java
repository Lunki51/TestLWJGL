...
public class Window {
    ...
    private Input input;
    private Vector3f background = new Vector3f(0.1f, 0.1f, 0.5f);
    private GLFWWindowSizeCallback sizeCallback;
    private boolean isResized;
    private boolean isFullscreen;
    private int[] windowPosX = new int[1], windowPosY = new int[1];
    private Matrix4f projection;
    private double delta,lastFrameTime;

    public Window(int width, int height, String title) {
        this.width = width;
        this.height = height;
        this.title = title;
        projection = Matrix4f.projection(90.0f, (float) width / (float) height, 0.1f, 1000);
    }
    ...
    public void update() {
        ...
        delta = (System.currentTimeMillis()-lastFrameTime)/1000;
        lastFrameTime=System.currentTimeMillis();
